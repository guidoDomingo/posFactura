<?php
    ...
    $pdf->MultiCell(0,5,utf8_decode(strtoupper("Inventory SYSTEM")),0,'C',false);
    $pdf->SetFont('Arial','',9);
    ...
    $pdf->MultiCell(0,5,utf8_decode("Email: inventory@egmail.com"),0,'C',false);

    $pdf->Ln(1);
    $pdf->Cell(0,5,utf8_decode("------------------------------------------------------"),0,0,'C');
    $pdf->Ln(5);

    $pdf->MultiCell(0,5,utf8_decode("Fecha: ".$fecha." ".date("h:i A")),0,'C',false);
    ...
    foreach ($productos as $key => $item) {
        ...
        $pdf->MultiCell(0,4,utf8_decode("Producto: ".$item['descripcion']),0,'C',false);
